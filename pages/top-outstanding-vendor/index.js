// pages/top-outstanding-vendor/index.js
...
import TopOutstandingVendorPage from "components/page/top-outstanding/TopOutstandingVendorPage";

const TOP_OUTSTANDING_PASSWORD = "Outstanding_Report_2026";

export default function TopOutstandingVendorEntry() {
    ...
    return (
      <div style={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "70vh" }}>
        <div style={{ width: 360, padding: 28, border: "1px solid #dee2e6", borderRadius: 12, background: "#fff", boxShadow: "0 4px 16px rgba(0,0,0,0.06)" }}>
          <h5 style={{ marginBottom: 4 }}>🔒 Top Outstanding Vendor</h5>
  ...
  return <TopOutstandingVendorPage password={password} />;
}
