...
// pages/stock-check/first-page.js - Updated to include pack size column
import React from 'react';

export default function ThreeColumnTable({ onTransmit, onBack, firstPageData, onDataChange, onClearAll }) {
  const { headerRefNo, headerDiscount, tableData } = firstPageData;

  // UOM options for pack size dropdown
  const uomOptions = [
    'µg', 'cm²', 'EA', 'GM', 'GN', 'KG', 'L', 'm', 'MG', 'MH', 'ML', 'mm', 'mm²', 'pcs', 'slug'
  ];
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                ...
                <div>
                  <h2 style={{ fontSize: '28px', fontWeight: 'bold', color: '#1e40af', margin: 0 }}>Quick Quote</h2>
                  <p style={{ fontSize: '16px', color: '#2563eb', marginTop: '8px', margin: '8px 0 0 0' }}>Paste the CAS entries, Pack Size, Ref no and Discount</p>
                </div>
              </div>
              <div style={{ display: 'flex', gap: '12px' }}>
                <button
                  ...
                  <tr>
                    ...
                    <th style={{ padding: '24px', textAlign: 'left', fontSize: '16px', fontWeight: 'bold', color: '#1e40af', borderRight: '2px solid #60a5fa', width: '25%' }}>
                      ...
                      <div style={{ 
                        ...
                        Optional - Enter quantity and select UOM
                      </div>
                    </th>
                    <th style={{ padding: '24px', textAlign: 'left', fontSize: '16px', fontWeight: 'bold', color: '#1e40af', borderRight: '2px solid #60a5fa', width: '25%' }}>
                      Reference No
                      ...
                      <tr key={row.id} style={{ borderBottom: '1px solid #dbeafe' }}>
                        ...
                        <td style={{ padding: '16px 24px', borderRight: '1px solid #93c5fd', width: '25%', verticalAlign: 'top' }}>
                          <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                            ...
                            />
                            <select
                              value={row.packSize?.uom || ''}
                              onChange={(e) => handlePackSizeChange(index, 'uom', e.target.value)}
                              style={{
                                flex: '1',
                                padding: '12px 16px',
                                border: '1px solid #93c5fd',
              ...
              <div style={{ 
                ...
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                  <div style={{ fontSize: '16px', color: '#1d4ed8', fontWeight: '500' }}>
                    Total Rows: <span style={{ fontWeight: 'bold', color: '#1e40af' }}>{tableData.length}</span> | 
                    CAS Entries: <span style={{ fontWeight: 'bold', color: '#1e40af' }}>{tableData.filter(row => row.casNo.trim() !== '').length}</span> |
                    Pack Sizes: <span style={{ fontWeight: 'bold', color: '#1e40af' }}>{tableData.filter(row => row.packSize?.quantity && row.packSize?.uom).length}</span>
                  </div>
                </div>
              </div>
            </div>
