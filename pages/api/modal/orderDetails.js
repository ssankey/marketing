...
//         T12.Dscription AS "Description",
//         T12.U_CasNo AS "Cas No",
//         T12.VendorNum AS "Vendor Catalog No.",
//         T12.U_Packsize AS "PKZ",
//         T12.Quantity AS "Qty",
//         CASE 
//           WHEN T13.DocStatus = 'C' AND T13.CANCELED = 'N' THEN 'Closed'
//           WHEN T13.DocStatus = 'C' AND T13.CANCELED = 'Y' THEN 'Cancelled'
//           WHEN T13.DocStatus = 'O' THEN 'Open'
//           ELSE 'NA'
//         END AS "Status",
