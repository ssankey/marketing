...
// //     // pages/api/dashboard.js
// // // REPLACE the kpiData array section (around line 140-200) with this:
...
// //     trendContext: "Compared to Last Period",
// //   },
// //   // 🔄 CHANGED: Quotation Conversion Rate → Order Value
// //   {
// //     title: `Order Value`,
// //     value: formatCurrency(currentMetrics.totalOrderValue || 0),
// //     icon: "GraphUpArrow",
// //     color: "warning",
// //     trend:
// //       dateFilter === "custom"
// //         ? null
// //         : currentMetrics.totalOrderValue >
// //           (previousMetrics.totalOrderValue || 0)
// //         ? "up"
// //         : "down",
// //     trendValue:
// //       dateFilter === "custom"
...
// //         : calculateTrend(
// //             currentMetrics.totalOrderValue,
// //             previousMetrics.totalOrderValue
// //           ),
// //     prevValue: formatCurrency(previousMetrics.totalOrderValue || 0),
// //     trendContext: "Compared to Last Period",
// //   },
// //   {
...
//   try {
//     // ✅ Check if user has 3ASenrise role and apply category filter
//     const is3ASenrise = decoded.role === '3ASenrise';
//     const categoryFilter = is3ASenrise ? '3A Chemicals' : salesCategory;
...
//       customer,
//       salesPerson,
//       salesCategory: categoryFilter, // ✅ Apply 3A Chemicals filter for 3ASenrise
//     };
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const modalParams = {
      ...
      contactCodes: decoded.contactCodes || [],
      cardCodes: decoded.cardCodes || [],
      // ✅ PASS ROLE AND SALES CATEGORY
      role: decoded.role, // This is crucial for 3ASenrise filtering
      salesCategory: categoryFilter,
    };
