...
//     // Extract ordered months - they're already sorted by the query
...
//     // Build the PIVOT columns string in the correct chronological order
...
//     console.log("Executing main query with parameters:", params);
//     const result = await queryDatabase(query, params);

//     // Transform the data for charting
//     const categories = result.map((row) => row.Category);
//     // Use the chronologically ordered months
