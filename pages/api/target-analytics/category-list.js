...
//   try {
//     const query = `
//       SELECT DISTINCT ITMGRP.ItmsGrpNam
//       FROM OINV T0
//       INNER JOIN INV1 T1 ON T0.DocEntry = T1.DocEntry
//       LEFT JOIN OITM ITM ON T1.ItemCode = ITM.ItemCode
//       LEFT JOIN OITB ITMGRP ON ITM.ItmsGrpCod = ITMGRP.ItmsGrpCod
//       WHERE ITMGRP.ItmsGrpNam IS NOT NULL AND ITMGRP.ItmsGrpNam <> ''
//       ORDER BY ITMGRP.ItmsGrpNam ASC
//     `;

//     const results = await queryDatabase(query);
    
//     const categoryList = results.map(row => row.ItmsGrpNam);
