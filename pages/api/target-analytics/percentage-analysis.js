...
//   try {
//     const { type = "category" } = req.query; // category, state, region, salesperson
...
//         ? contactCodes.join("-")
//         : cardCodes.join("-");
//     const cacheKey = `target-analytics:percentage:${userIdentifier}:${type}`;
...
//     const responseData = { data: results, type };
