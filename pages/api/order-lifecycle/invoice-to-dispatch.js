...
// // // // // // pages/api/order-lifecycle/invoice-to-dispatch.js
...
// // // // //   try {
// // // // //     const { slpCode, cardCode, cntctCode, itmsGrpCod } = req.query;
...
// // // // //     }
// // // // //     if (itmsGrpCod) {
// // // // //       whereParts.push("T5.ItmsGrpCod = @itmsGrpCod");
...
// // // // //           FROM OINV 
// // // // //           ${itmsGrpCod ? 'JOIN INV1 T1 ON OINV.DocEntry = T1.DocEntry JOIN OITM T5 ON T1.ItemCode = T5.ItemCode' : ''}
// // // // //           WHERE ${whereSQL}
// // // // //       ),
// // // // //       BucketCounts AS (
// // // // //           SELECT 
...
// // // // //               CAST(
// // // // //                   100.0 * TotalCount / 
// // // // //                   SUM(TotalCount) OVER (PARTITION BY Type, Month)
// // // // //                   AS DECIMAL(5,2)
// // // // //               ) AS Percentage
// // // // //           FROM BucketCounts
// // // // //       )
...
// // // // //       MonthNumber: parseInt(r.MonthNumber),
// // // // //       Bucket: r.Bucket,
...
//       LEFT JOIN OITM ITM ON I1.ItemCode = ITM.ItemCode
//       LEFT JOIN OITB ITB ON ITM.ItmsGrpCod = ITB.ItmsGrpCod
//       WHERE OINV.CANCELED = 'N' AND OINV.U_DispatchDate IS NOT NULL
//     `;
