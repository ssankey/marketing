...
//                 const localUrl = `${baseUrl}/api/coa/download/${encodedFilename}`;
...
//                 // Use our proxy endpoint for Energy COAs to force download
//                 const proxyUrl = `${baseUrl}/api/coa/download-energy/${encodeURIComponent(ItemNo)}/${encodeURIComponent(VendorBatchNum.trim())}`;
//                 console.log(`  Generated ENERGY PROXY URL: ${proxyUrl}`);
//                 return proxyUrl;
//             }
//             break;
