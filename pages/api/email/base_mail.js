...
const smtpAccounts = {
  ...
  "gurpreet@densitypharmachem.com": {
    user: "gurpreet@densitypharmachem.com",
    pass: process.env.GURPREET_EMAIL_PASS,
    fromName: "Density Pharmachem",
  },
  "customerservice@densitypharmachem.com": {
    user: "customerservice@densitypharmachem.com",
    pass: process.env.CUSTOMERSERVICE_EMAIL_PASS,
    fromName: "Customer Service - Density Pharmachem",
  },
};
