...
export async function getAllQuotations({
  ...
  try {
    ...
    // If the user is not an admin and has a list of contactCodes,
    // restrict the quotations to those linked to the permitted CardCodes.
...
export async function getAllInvoices({ status, search, sortField, sortDir,fromDate,toDate,isAdmin = false,
  contactCodes = [],}) {
  try {
    let whereClause = "1=1";
