...
//   // 2) Status Filter (Now includes Partial inside the same CASE)
//   if (status !== "all") {
//     whereClause += `
//       AND (
//         CASE
//           WHEN (
//             -- PARTIAL LOGIC:
//             -- The order is open (DocStatus='O')
//             -- AND it has at least one fully invoiced line
//             -- AND it has at least one non-invoiced line
//             T0.DocStatus = 'O'
//             AND EXISTS (
//               SELECT 1
//               FROM RDR1 T1
