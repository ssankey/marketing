...
export async function getProductKPIs(id) {
  ...
  const [kpiData, salesTrendData, topCustomersData, inventoryData, pricingHistoryData] = await Promise.all([
    ...
    // queryDatabase(pricingHistoryQuery, params),
  ]);
  ...
  return {
    ...
    pricingHistoryData,  // Array of pricing history
  };
}
