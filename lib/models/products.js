...
//   // Stock status filter -> WHERE fragment (no aggregation)
//   let whereStockFilter = "";
//   if (status === "inStock") {
//     whereStockFilter = " AND COALESCE(T2.OnHand, 0) > 0";
//   } else if (status === "outOfStock") {
//     // treat NULL or 0 as out of stock
//     whereStockFilter = " AND COALESCE(T2.OnHand, 0) = 0";
//   }

//   // Determine sort column (no SUM now)
//   let sortColumn = "T0.ItemCode";
//   if (sortField === "ItemName") sortColumn = "T0.ItemName";
//   else if (sortField === "Category") sortColumn = "T1.ItmsGrpNam";
//   else if (sortField === "CreateDate") sortColumn = "T0.CreateDate";
//   else if (sortField === "UpdateDate") sortColumn = "T0.UpdateDate";
//   else if (sortField === "OnHand" || sortField === "stockStatus") sortColumn = "T2.OnHand";

//   // COUNT matches the exact joined rowset (duplicates included)
//   const countQuery = `
...
//   // Data query without derived table or GROUP BY/SUM
//   const dataQuery = `
//     SELECT
//       T0.ItemCode,
//       T0.ItemName,
...
//       // You aren't selecting VendorBatchNum; keeping behavior consistent:
//       vendorbatchnum: product.VendorBatchNum || null,
//     }));
