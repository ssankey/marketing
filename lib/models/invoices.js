...
export async function getInvoicesList({
  ...
  let whereClause = "T0.CANCELED = 'N' AND T0.[IssReason] <> '4'";
  ...
  try {
    ...
    console.log(`Fetched ${invoices.length} invoice line items out of ${totalItems} total`);
...
export async function getUniqueInvoicesList({
  ...
  LineItemCount: parseInt(invoice.LineItemCount || 0),
    ...
    console.log(`Fetched ${invoices.length} invoices out of ${totalItems} total`);
