...
//   // Updated count query with Category join
//   const countQuery = `
//     SELECT COUNT(*) AS total
//     FROM OINV T0
//     INNER JOIN INV1 T1 ON T0.DocEntry = T1.DocEntry
...
//   // Updated main query with Category field
//   const dataQuery = `
//     SELECT 
//       -- Basic Invoice Info
//       T0.DocEntry,
...
// lib/models/invoices.js (updated getInvoicesList function)
