...
//   const { status, fromDate: urlFromDate, toDate: urlToDate } = router.query;
...
//     handleReset,
//     setAllData 
//   } = useOrdersData(orders, status || initialStatus, initialPage, pageSize);

//   // Set dates from URL parameters when component mounts or URL changes
//   useEffect(() => {
//     if (urlFromDate && urlFromDate !== fromDate) {
//       setFromDate(urlFromDate);
//     }
//     if (urlToDate && urlToDate !== toDate) {
//       setToDate(urlToDate);
//     }
//   }, [urlFromDate, urlToDate, fromDate, toDate, setFromDate, setToDate]);
...
//   // Custom reset handler that also clears URL parameters
...
//         {/* Show current filter info from URL */}
//         {(false) && (
//           <Alert variant="info" className="mb-3">
//             <div className="d-flex justify-content-between align-items-center">
//               <span>
//                 <strong>Filtered by date:</strong> 
//                 {urlFromDate && <span className="ms-2">From: {formatDate(urlFromDate)}</span>}
//                 {urlToDate && <span className="ms-2">To: {formatDate(urlToDate)}</span>}
...
const OrdersTable = ({
  ...
  }, [status, urlFromDate, urlToDate, filtersChanged, setStatusFilter, setFromDate, setToDate]);
