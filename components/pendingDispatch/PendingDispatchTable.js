...
const PendingDispatchTable = ({
  ...
  const {
    ...
    handleExportExcel,
    setError
  } = usePendingDispatchData(initialStatus, initialPage, pageSize);
            ...
            >
                      ...
                      <td colSpan={columns.length} className="text-center py-5">
                        <div className="d-flex flex-column align-items-center justify-content-center" style={{minHeight: '200px'}}>
                          {loading ? (
                            <>
                              <Spinner animation="border" variant="primary" className="mb-3" />
                              <h5 className="text-muted mb-2">Loading pending dispatch invoices...</h5>
                              <p className="text-muted small mb-0">Please wait while we fetch your data</p>
                            </>
                          ) : (
                            <>
                              ...
                              <h5 className="text-muted mb-2">No pending dispatch invoices found</h5>
                              <p className="text-muted small mb-0">Try adjusting your search criteria or filters</p>
                            </>
                          )}
                        </div>
              ...
              {loading && (
                ...
                >
                  <div className="text-center">
                    <Spinner animation="border" variant="primary" style={{width: '3rem', height: '3rem'}} />
                    <p className="mt-3 mb-0 fw-medium text-primary">Loading pending dispatch invoices...</p>
                  </div>
                </div>
              )}
            </div>
