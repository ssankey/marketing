              ...
              <Row>
                <Col md={4}>
                  <p>
                    ...
                    {formatCurrency(quotation.Subtotal)} {quotation.DocCur}
                  </p>
                  <p>
                    <strong>Tax Total:</strong>{" "}
                    {formatCurrency(quotation.TaxTotal)} {quotation.DocCur}
                  </p>
                </Col>
                <Col md={4}>
                  <p>
                    <strong>Discount Total:</strong>{" "}
                    {formatCurrency(quotation.DiscountTotal)} {quotation.DocCur}
                  </p>
                  <p>
                    <strong>Shipping Fee:</strong>{" "}
                    {formatCurrency(quotation.ShippingFee)} {quotation.DocCur}
                  </p>
                </Col>
                <Col md={4}>
                  <p>
                    <strong>Total Amount:</strong>{" "}
                    {formatCurrency(quotation.DocTotal)} {quotation.DocCur}
                  </p>
                  <p>
                      ...
                      return (
                        <tr key={index}>
                          ...
                          <td className="text-nowrap">
                            ...
                            {product.Currency || quotation.DocCur}
                          </td>
                          <td className="text-nowrap">
