...
const OrdersChart = () => {
  ...
  const exportToCSV = () => {
    ...
    const csvData = [
      ...
      [
        "Closed Orders (Sales)",
        ...ordersData.map((data) => formatCurrency(data.closedSales || 0)),
      ],
    ];
  ...
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-white py-3">
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
          <h4 className="mb-3 mb-md-0" style={{ fontWeight: 600 }}>
            Monthly Open vs Closed Orders
          </h4>
          <div className="d-flex flex-column flex-md-row gap-2 align-items-md-center mt-3 mt-md-0">
            <YearSelector />
      ...
      <Card.Body>
        ...
        {loading ? (
          ...
          <p className="text-center mt-4">No data available for the selected year.</p>
        )}
      </Card.Body>
    </Card>
  );
