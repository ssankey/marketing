...
//     // Handle dropdown selection (filter type change)
//     const handleSearchTypeSelect = async (type) => {
//         setSearchType(type);
...
//             });
//         } else {
//             setSearchQuery(null); // Clear search query when no option is selected
//         }
//     };
...
//   // Reset function (clears input and freezes it)
//   const handleReset = () => {
//     setSearchType(null);
//     setSelectedValue(null);
//     setSearchQuery(null); // Reset search query
